    ...
    async getSites() {
        ...
        return data.map(site => {
            ...
            return {
                ...
                checkedIn: meta.checked_in || '',
                checkedOut: meta.checked_out || '',
                leaseAreaIssues: meta.lease_area_issues || '',
                // Measurements
                measurement1: meta.measurement_1 || '',
                measurement2: meta.measurement_2 || '',
                measurement3: meta.measurement_3 || '',
                measurement4: meta.measurement_4 || '',
                measurement5: meta.measurement_5 || '',
                measurement6: meta.measurement_6 || '',
                measurement7: meta.measurement_7 || '',
                measurement8: meta.measurement_8 || '',
                measurement9: meta.measurement_9 || '',
                measurement10: meta.measurement_10 || '',
                measurement11: meta.measurement_11 || '',
                // Legacy fields
